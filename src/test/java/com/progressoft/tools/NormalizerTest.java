...
import com.progressoft.NormalizerImplementation;
...
public class NormalizerTest {
  ...
  public void beforeEach() {
    ...
    normalizer = new NormalizerImplementation();
  }
  ...
  public void givenMarksCSVFileToScale_whenMarkColumnIsZScored_thenNewCSVFileIsGeneratedWithAdditionalZScoreColumn()
    ...
    Assertions.assertEquals(new BigDecimal("16.73"), summary.standardDeviation(),
  ...
  public void givenEmployeesCSVFileToScale_whenSalaryColumnIsZScored_thenNewCSVFileIsGeneratedWithAdditionalZScoreColumn()
    ...
    Assertions.assertEquals(new BigDecimal("785.19"), summary.standardDeviation(),
                            "invalid standard deviation"
                           );
    Assertions.assertEquals(new BigDecimal("616523.00"), summary.variance(),
                            "invalid variance"
                           );
  ...
  private void assertLines(List<String> generatedLines, List<String> expectedLines) {
    Assertions.assertTrue(generatedLines.size() == expectedLines.size(),
